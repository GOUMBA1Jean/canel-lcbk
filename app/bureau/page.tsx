const bureau = [
  {
    nom: "DOURO SAMUEL GOUMEH",
    role: "Président du bureau CANEL-LCBK",
    whatsapp: "+23566308130",
    mail: "dourousamuel@gmail.com",
  },
  {
    nom: "NGAGUE OLIVIER",
    role: "Vice-Président",
    whatsapp: "+23565027470",
    mail: "olivierngague@gmail.com",
  },
  {
    nom: "DANAI NDJAHA GERARD",
    role: "Secrétaire",
    whatsapp: "+23566521369",
    mail: "danaindjaha@mail.com",
  },
];
        ...
        <div className="max-w-[1120px] mx-auto px-5 md:px-8">
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    >
                      ...
                      href={`mailto:${m.mail}`}
                      className="inline-flex items-center gap-2 border border-indigo text-indigo text-[13px] font-medium px-4 py-2 rounded-sm w-fit"
                    >
          ...
          <div className="bg-sand-2 border border-[#E3D9BC] rounded p-8 max-w-xl">
            ...
            >
              ...
              Rejoindre le groupe CANEL-LCBK
            </a>
          </div>
        </div>
      </section>
